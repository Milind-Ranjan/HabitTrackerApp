        ...
        >
          ...
          <div className="flex flex-col items-center mb-10">
            <div className="w-20 h-20 mb-6 relative group">
              <div
                className="absolute inset-0 rounded-full blur-2xl scale-150 transition-all duration-700 group-hover:opacity-100 opacity-0"
          ...
          <form onSubmit={handleLogin} className="flex flex-col gap-5">
            {[
              ...
              <input
                ...
                required
                className="w-full rounded-2xl px-6 py-4 font-medium outline-none"
                style={{
                ...
                onFocus={e => {
                  (e.target as HTMLElement).style.borderColor = 'rgba(96,165,250,0.5)';
                  (e.target as HTMLElement).style.background = 'rgba(255,255,255,0.06)';
                  (e.target as HTMLElement).style.boxShadow = '0 0 0 4px rgba(59,130,246,0.08)';
                }}
                onBlur={e => {
